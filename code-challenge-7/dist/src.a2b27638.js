...
function handleRange(event) {
  var changedMax = event.target.value;
  rangeText.innerHTML = "Generate a number between 0 and ".concat(changedMax);
  maxValue = changedMax;
}
...
function handleChoose() {
  if (parseInt(maxValue) < parseInt(input.value)) {
    ...
    choose.innerHTML = "You chose : ".concat(input.value, ", the machine chose : ").concat(randomNumber);
